                    ...
                    <div class="impact-section">
                        ...
                        <div class="impact-value-container">
                            <span class="impact-value"
                                >{project.impact.value}</span
                            >
                            <span class="impact-desc"
                                >{project.impact.description}</span
                            >
                        </div>
                        <button class="view-project-btn"
                            >View Full Project <span class="btn-arrow">→</span
                            ></button
                        >
                    </div>
                </div>
                    ...
                    <div class="architecture-visual">
                        <div class="arch-header">
                            <span class="arch-title"
                                >{project.architecture.title}</span
                            >
